...
namespace WebApp.Identity
{
    public class MyUserStore : IUserStore<MyUser>, IUserPasswordStore<MyUser>
    {
        ...
        {
            var connection = new SqlConnection(@"Data Source=(localdb)\MSSQLLocalDB;Initial Catalog=IdentityCurso;Integrated Security=True;");
            //var connection = new SqlConnection(@"Server=localhost\MSSQLocalDB;Database=IdentityCurso; Integrated Security=True;"); 
